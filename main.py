...
def main():
    ...
    PyCR.runPyCR('true',0.34,'false','classTupa','false','','input/coffee/data_coffee.csv', 'input/coffee/class_coffee.csv', 'input/coffee/Sname_coffee.csv', 'input/coffee/Vname_coffee.csv', 'AutoScale', 5,0.85,'vip',3)
