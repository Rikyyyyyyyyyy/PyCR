...
def main():
    ...
    #PyCR.runPyCR('true',0.34,'false','classTupa','false','','input/algae/data_algae.csv', 'input/algae/class_algae_string.csv', 'input/algae/S_name.csv', 'input/algae/v_name.csv', 'AutoScale', 100,0.85,'vip',3)
    ...
    PyCR.runPyCR('true',0.34,'false','notupa','false','','input/PANCAN/data_PANCAN.csv', 'input/PANCAN/labels_PANCAN.csv', 'input/PANCAN/Sname_PANCAN.csv', 'input/PANCAN/Vname_PANCAN.csv', 'AutoScale', 100,0.85,'vip',3)
